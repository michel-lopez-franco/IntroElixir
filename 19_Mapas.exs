...
map2 = %{1 => 'lunes', 2 => 'martes', 3 => 'miercoles', 4 => 'jueves', 5 => 'viernes', 1 => 'sabado', 7 => 'domingo'}
kv2 = ["1": 'cinco']
IO.inspect(map2)
IO.inspect(map2[1])
IO.inspect(kv2)
...
map3 = %{:dia1 => 'lunes', :dia2 =>'martes', "dia4" => 'miercoles'}
...
IO.inspect( %{1 => 'uno', 2 => 'dos'} == %{2 => 'dos', 1 => 'uno'})
...
case datos do
  %{nombre: nombre, edad: edad} -> IO.puts("Nombre: #{nombre}, Edad: #{edad}")
  %{nombre: nombre, edad: edad, ciudad: ciudad} -> IO.puts("Nombre: #{nombre}, Edad: #{edad}, Ciudad: #{ciudad}")
  _ -> IO.puts("No se pudo obtener los datos")
end
...
[edad: queedad, ciudad: queciudad] = [edad: 30, ciudad: "Lima"] # :Ok
IO.inspect( queciudad  )
IO.inspect( queedad)
